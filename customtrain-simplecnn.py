...
MODEL_NETWORK_NAME = "SimpleModel"
...
model = tf.keras.Sequential(name=MODEL_NETWORK_NAME)
model.add(Conv2D(12,kernel_size=3,activation='relu',padding='same',input_shape=input_shape))
model.add(Conv2D(24,kernel_size=3,activation='relu',padding='same',input_shape=input_shape))
model.add(Conv2D(36,kernel_size=3,activation='relu',padding='same',input_shape=input_shape))
model.add(MaxPooling2D(3,3))

model.add(Conv2D(48,kernel_size=3,padding='valid',activation='relu'))
model.add(MaxPooling2D(2,2))
model.add(Conv2D(96,kernel_size=3,strides=2,padding='valid',activation='relu'))
model.add(BatchNormalization())
#model.add(Conv2D(128,kernel_size=3,strides=2,padding='valid',activation='relu'))
model.add(Conv2D(192,kernel_size=3,strides=2,padding='valid',activation='relu'))
model.add(MaxPooling2D(2,2))
